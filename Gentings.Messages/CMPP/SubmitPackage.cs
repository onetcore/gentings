...
namespace Gentings.Messages.CMPP
{
    ...
    public class SubmitPackage : IPackage
    {
        ...
        public SubmitPackage(MsgFormat msgfmt, string msg, params string[] destTerminalId)
        {
            ...
            Header = new PackageHeader((uint)Size, OpCode.CMPP_SUBMIT, 0);
        }
        ...
        public byte[] ToBytes()
        {
            ...
            //Msg_src 
            buffer = Encoding.ASCII.GetBytes(Spid);
        ...
        /// </summary>
        public FeeTerminalType FeeTerminalType { get; set; }
        ...
        /// </summary>
        public uint DestTerminalType { get; set; }
