...
namespace Gentings.Extensions.Sites.TagHelpers
{
    ...
    public class SectionsTagHelper : PageTagHelperBase
    {
        ...
        public override async void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            foreach (var section in Context.Sections)
            {
                ...
                var sctx = new SectionContext(Context, section);
                var sectionType = sectionManager.GetSectionRender(section.RenderName);
                await sectionType.ProcessAsync(sctx, builder);
    ...
    public class SectionTagHelper : PageTagHelperBase
    {
        ...
        public override async void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var sctx = new SectionContext(Context, Section);
            var sectionType = _sectionManager.GetSectionRender(Section.RenderName);
            await sectionType.ProcessAsync(sctx, builder);
