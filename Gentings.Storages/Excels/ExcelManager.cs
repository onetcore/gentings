...
namespace Gentings.Storages.Excels
{
    ...
    public class ExcelManager : IExcelManager
    {
        ...
        public void Save<TModel>(IEnumerable<TModel> models, string path, string sheetName = "sheet1", uint sheetId = 1) where TModel : class, new()
        {
