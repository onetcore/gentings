...
namespace Gentings.Storages.Excels
{
    /// <summary>
    /// EXCEL管理接口。
    /// </summary>
    public interface IExcelManager : ISingletonService
    {
        ...
        void Save<TModel>(IEnumerable<TModel> models, string path, string sheetName = "sheet1", uint sheetId = 1)
            where TModel : class, new();
        ...
        PhysicalFileResult Export<TModel>(IEnumerable<TModel> models, string fileName, string sheetName = "sheet1", uint sheetId = 1)
            where TModel : class, new();
        ...
        /// <param name="sheetName">工作表名称。</param>
        /// <param name="sheetId">索引Id。</param>
        void Save(string path, DataTable models, string sheetName = "sheet1", uint sheetId = 1);
        ...
        /// <param name="sheetId">索引Id。</param>
        /// <returns>返回物理路径试图结果。</returns>
        PhysicalFileResult Export(DataTable models, string fileName, string sheetName = "sheet1", uint sheetId = 1);
    }
}