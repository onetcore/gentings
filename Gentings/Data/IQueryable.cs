...
namespace Gentings.Data
{
    ...
    public interface IQueryable<TModel> : IQueryContext<TModel>
    {
        ...
        /// <param name="alias">别名。</param>
        /// <returns>返回当前查询实例对象。</returns>
        new IQueryable<TModel> Select(Expression<Func<TModel, object?>> field, string alias);
        ...
        /// <param name="isDesc">是否为降序。</param>
        /// <returns>返回当前查询实例对象。</returns>
        new IQueryable<TModel> OrderBy(string field, bool isDesc);
        ...
        /// <param name="field">列名称。</param>
        /// <returns>返回当前查询实例对象。</returns>
        new IQueryable<TModel> OrderByDescending(string field);
        ...
        /// <param name="isDesc">是否为降序。</param>
        /// <returns>返回当前查询实例对象。</returns>
        new IQueryable<TModel> OrderBy<TEntity>(string field, bool isDesc);
        ...
        /// <param name="field">列名称。</param>
        /// <returns>返回当前查询实例对象。</returns>
        new IQueryable<TModel> OrderByDescending<TEntity>(string field);
        ...
        /// </summary>
        /// <returns>返回当前查询实例对象。</returns>
        new IQueryable<TModel> OrderByRandom();
