...
namespace GCApp.Services
{
    ...
    public class ServiceContext
    {
        ...
        /// 当前服务配置。
        /// </summary>
        public ICMPPServiceProvider Configuration { get; }
        ...
        public async Task<SubmitMessage> SubmitAsync(string msg, params string[] phoneNumbers)
        {
            ...
            package.MsgSrc = Configuration.Spid;
        ...
        public Task<TMessage> ReadMessageAsync<TMessage>()
            where TMessage : class, IMessage
        {
            return _networkStream.ReadMessageAsync<TMessage>();
        }

        /// <summary>
        /// 将实例写入到网络流中。
        /// </summary>
        public Task WritePackageAsync(IPackage package) => _networkStream.WritePackageAsync(package);
