...
namespace Gentings.Identity.Data
{
        ...
        where TUserToken : UserTokenBase, new()
    {
        ...
        IPageEnumerable<TUser> Load<TQuery>(TQuery query, Expression<Func<TUser, object>> countExpression = null) where TQuery : UserQuery<TUser>;
        ...
        /// <param name="countExpression">返回总记录数的表达式,用于多表拼接过滤重复记录数。</param>
        /// <returns>返回查询分页实例。</returns>
        IPageEnumerable<TUserModel> Load<TQuery, TUserModel>(TQuery query, Expression<Func<TUser, object>> countExpression = null) where TQuery : UserQuery<TUser>;
        ...
        /// <param name="cancellationToken">取消标志。</param>
        /// <returns>返回查询分页实例。</returns>
        Task<IPageEnumerable<TUser>> LoadAsync<TQuery>(TQuery query, Expression<Func<TUser, object>> countExpression = null, CancellationToken cancellationToken = default) where TQuery : UserQuery<TUser>;
        ...
        /// <param name="cancellationToken">取消标志。</param>
        /// <returns>返回查询分页实例。</returns>
        Task<IPageEnumerable<TUserModel>> LoadAsync<TQuery, TUserModel>(TQuery query, Expression<Func<TUser, object>> countExpression = null, CancellationToken cancellationToken = default) where TQuery : UserQuery<TUser>;
