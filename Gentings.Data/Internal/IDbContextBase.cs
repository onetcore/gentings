...
namespace Gentings.Data.Internal
{
    ...
    public interface IDbContextBase<TModel> : IDbExecutor
    {
        ...
        /// <returns>返回是否更新成功。</returns>
        bool Update(object key, object fields);
        ...
        /// <param name="fields">更新选项实例。</param>
        /// <returns>返回是否更新成功。</returns>
        bool Update(Expression<Predicate<TModel>> expression, object fields);
        ...
        /// <param name="cancellationToken">取消标记。</param>
        /// <returns>返回是否更新成功。</returns>
        Task<bool> UpdateAsync(object key, object fields, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">取消标记。</param>
        /// <returns>返回是否更新成功。</returns>
        Task<bool> UpdateAsync(object fields, CancellationToken cancellationToken = default);
